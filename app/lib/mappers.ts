...
export function mapTripFromPrisma(trip: PrismaTrip): Trip {
  return {
    ...
    depositAmount: trip.depositAmount ?? undefined,
...
export function mapTourFromPrisma(tour: PrismaTour): Tour {
  return {
    ...
    depositAmount: tour.depositAmount ?? undefined,
